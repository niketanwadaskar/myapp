    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogContent className="bg-white rounded-lg shadow-lg max-w-md mx-auto">
          <DialogHeader>
            <DialogTitle className="text-xl font-semibold text-[#ff748d]">
              Edit Post
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            {selectedPost && (
              <>
                <p className="text-gray-600">Author: {selectedPost.author}</p>
                <textarea
                  className="w-full p-2 border border-gray-300 rounded focus:ring-2 focus:ring-[#ff748d] focus:border-transparent"
            ...
            <div className="flex justify-end space-x-2">
              <button
                className="px-4 py-2 bg-[#ff748d] text-white rounded hover:bg-[#ff5f7d] transition-colors"
