...
export default function Following({ following, currentUser, handleFollow, handleUnfollow }:{
    following: User[], currentUser: User, handleFollow: (user: User) => void, handleUnfollow: (user: User) => void}) {
  return (
    // <div>
      <ul className="">
                  {following.map((user) => (
